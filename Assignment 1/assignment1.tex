...
##  my_knn_R(X, X0, y) 697.261 708.496 741.5092 726.992 747.9315 1910.682   100
\end{verbatim}
...
##  FNN::knn(X, matrix(X0, nrow = 1), y, k = 1) 216.432 220.431 226.9919 223.391
##        uq     max neval
##  224.8665 433.971   100
\end{verbatim}
...
## Unit: microseconds
##             expr   min    lq     mean median    uq     max neval
##  knn_1(X, X0, y) 4.271 4.431 12.14981  4.481 4.541 770.461   100
\end{verbatim}
...
## Unit: microseconds
##                   expr    min     lq     mean median     uq     max neval
##  knn_more(X, X0, y, 3) 13.621 13.851 22.89774 13.926 14.046 908.141   100
\end{verbatim}
...
## Unit: microseconds
##                   expr    min     lq    mean median     uq    max neval
##  knn_more(X, X0, y, 3) 13.631 13.811 14.9761 13.906 14.086 93.251   100
\end{verbatim}
...
## Unit: microseconds
##                                         expr     min      lq     mean  median
##  FNN::knn(X, matrix(X0, nrow = 1), y, k = 3) 217.622 219.381 227.0094 220.506
##       uq     max neval
##  224.271 447.171   100
\end{verbatim}
