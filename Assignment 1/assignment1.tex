...
##  my_knn_R(X, X0, y) 696.392 709.276 735.8177 722.897 733.036 1902.982   100
\end{verbatim}
...
##  FNN::knn(X, matrix(X0, nrow = 1), y, k = 1) 218.731 222.7255 229.695 224.7365
##       uq     max neval
##  227.761 546.161   100
\end{verbatim}
...
## Unit: microseconds
##             expr   min    lq    mean median    uq     max neval
##  knn_1(X, X0, y) 4.371 4.521 13.0393  4.561 4.666 841.941   100
\end{verbatim}
...
##  knn_more_R(X, X0, y, 3) 1.098562 1.123382 1.42881 1.141141 1.161192 24.81215
##  neval
##    100
\end{verbatim}
...
## Unit: microseconds
##                   expr    min     lq     mean median     uq     max neval
##  knn_more(X, X0, y, 3) 13.771 13.891 23.42828 13.951 14.046 957.391   100
\end{verbatim}
...
## Unit: microseconds
##                                         expr     min      lq     mean  median
##  FNN::knn(X, matrix(X0, nrow = 1), y, k = 3) 221.411 224.656 234.0578 227.656
##       uq     max neval
##  231.986 534.431   100
\end{verbatim}
